...
<body>
   <section>
        ...
        <form name="orderform" id="orderform">
         ...
         <c:set var = "motosum" value = "0" />
         <c:set var = "amountsum" value = "0" />
         <c:set var = "custom" value = "0" />
         <c:if test="${not empty list}">
         <c:forEach var="n" items="${list}" varStatus="e"> 
            <ul id="item">
                <li class="item" >
                	<input type="hidden" name="chk1" class="chk1" value="${n.cno}">
                	<input type="hidden" name="oamount" value="${n.oamount}">
                    <a href="#" class="product_img"><img src="${n.bcover}" class="img_book"></a>
                    <a href="#" class="product_info">${n.btitle}</a>
                    <div class="amount">${n.oamount}</div>
                    <div class="price">
                        <span class="selling">${n.oamount*n.bpricesales}</span>
                ...
                <c:set var= "amountsum" value="${amountsum + n.oamount}"/>
                <c:set var= "motosum" value="${motosum + (n.oamount*n.bpricestandard)}"/>
                <c:set var= "sum" value="${sum + (n.oamount*n.bpricesales)+n.dprice}"/>
                <c:set var="custom" value="${custom + n.dprice}"/> 
            </ul>
        </c:forEach>
        </c:if>
             ...
             <div id="pay_result">
                ...
                <table>
                    ...
                    <tr>
                        ...
                        <td class="result">${sum-motosum}</td>
                        <td>원</td>
                    </tr>
                    <tr class="underline">
                        <td class="row ">결제금액</td>
                        <td class="result">${sum+2500}</td>
                        <td>원</td>
                    </tr>
                </table>
            </div>
            ...
            <div id="payment">
                ...
                <ul>
                    ...
                    <input type="hidden" name="osalesprice" value="${sum}">
                    <input type="hidden" name="ototalprice" value="${motosum}">
                    <input type="hidden" name="ototalamount" value="${amountsum}">
                    </li>
                </ul>
            </div>
