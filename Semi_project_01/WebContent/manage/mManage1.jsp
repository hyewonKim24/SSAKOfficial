                    ...
                    <div class="mManage_pagination">
						...
						<c:if test="${startPage != endPage}">
							<c:forEach varStatus="s"  begin="${startPage}" end="${endPage}" step="1">
								<a href="<%=request.getContextPath() %>/memberList?pageNum=${s.count}">${s.count}</a>	<!--변경 : href 경로 -->
							</c:forEach>
						</c:if>
						</div>
					</div>
                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td>
                                   	  	<input type="text" name="msearchbar" id="mManage_searchbar">
                                      	<input type="button" name="mManage_searchbtn" id ="mManage_searchbtn" value="검색" onclick="goSearch()">
                                    </td>
                                </tr>
                            </tbody>
                        </table>
