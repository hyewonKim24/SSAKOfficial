...
<body>
    ...
    <form class="form_wrap">
        <table id="id_search_end_tbl">
            ...
            <tr>
                <td id="id_search_view">
                    아이디: 
            <c:if test="${not empty id_search_mid }">
				${id_search_mid }
            ...
            <tr>
                <td class="form_login_btn"><input type="button" class="form_btn1" onclick="location.href='./memberLogin.jsp'" value="로그인 하기"></td>
            </tr>
