...
<!-- 									<option value="2">커스텀문의</option>
									<option value="3">배송문의</option>
									<option value="4">회원문의</option>
						...
						<tr>
							...
							<td colspan="2" style="padding-left: 8px;"><input type="text" 
									name="qcontent" value="${param.qcontent }"
						...
						<tr>
							...
							<td colspan="2" style="padding-left: 8px;"><input type="password"
								name="qpw" value="${param.qpw }"style="width: 320px; height: 30px;">
							</td>
						</tr>
						<tr>
							<td colspan="3">
							<input type="hidden" name="qno" value="${param.qno }">
							<button type="button" onclick="endUpdate()"
